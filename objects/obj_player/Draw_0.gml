...
draw_sprite_ext(spr_robot_legs0, leg_frame, x, y+1, dir, 1, image_angle-h_speed*2*!grounded, c_white, 1);
draw_sprite_ext(spr_robothead, 0, head_x, head_y, body_dir, 1, head_angle, c_white, 1);
draw_sprite_ext(spr_robotgun_0, 0, gun_x, gun_y, body_dir, 1, arm_angle, c_white, 1);
